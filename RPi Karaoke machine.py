#####################################
# Calin Farmer, Christian Brunning
#
# Final Pi Project
####################################
...
song2Lyrics = [" ", "You know there's a light that glows by the front door", "Don't forget the keys under the mat", "When childhood stars shine", "Always stay humble and kind", \
        ...
        "Hold the door, ", "say please, say thank you", "Don't steal, don't cheat, and don't lie. I know you got", "got mountains to climb but Always", "stay humble and kind", \
        ...
        "Know", "Know the difference between sleepin' with someone", "And sleepin' with someone you love", "I love you ain't no pickup line so Always", "stay humble and kind", \
...
song3Lyrics = [" ", "Baby, lay on back and relax", "Kick your pretty feet up on my dash", "No need to go nowhere fast", "let's enjoy right here where we at", \
        ...
        "If it's meant to be, it'll be,",  "it'll be Baby, just let it be", "If it's meant to be, it'll", "be, it'll be. Baby, just let it be", "So won't you ride with me", \
        "ride with me? See where this", "thing goes. If it's meant to be, ", \
        "it'll be, it'll be. Baby, ", "if it's meant to be. I don't mean to", "be so uptight. But, my heart's been", "hurt a couple times by a couple ", \
        "guys that didn't treat me right. I ain't", " gon' lie, ain't gon' lie", "Cause I'm tired of the fake love, show me what you're made of ", "Boy, make me believe", \
        "Oh, hold up girl, don't you know you're beautiful?", "And it's easy to see", \
        ...
        "Maybe we do", "Maybe we don't. Maybe we will", "Maybe we won't. But if it's meant to be, ", "it'll be, it'll be. Baby, just let it", "be (sing it baby). If it's meant to be, ", \
        "it'll be, it'll be (c'mon). Baby, ", "just let it be (let's go). So won't you ", "ride with me ride with me?", \
        "See where this thing goes. If", "If it's meant to be, it'll be, it'll be" ,"Baby, if it's meant to be" ,"If it's meant to be, it'll be, it'll be", \
        "Baby, if it's meant to be", "If it's meant to be, it'll be, it'll be", "Baby, if it's meant to be" ]
...
class Karaoke(Frame):
    ...
    def show_lyric1(self, index = None):  #for song 1
        if index is not None:
            if index < len(Karaoke.currentSong.Lyrics):
                ...
                self.setStatus(txt)
                index += 1
                window.after(6000, lambda: self.show_lyric1(index))
        else:
            self.setStatus(" ")
    ...
    def process(self, event):
        ...
        if (choice == "twinkle twinkle little star"):
            ...
            mixer.music.play()
            window.after(14000), self.show_lyric1(0)
            ...
            mixer.music.play()
            window.after(20500, self.show_lyric2(0))
            ...
            mixer.music.play()
            window.after(8000, self.show_lyric3(0))
        else:
