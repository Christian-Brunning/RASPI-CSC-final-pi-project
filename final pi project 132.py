...
song3Lyrics = [" ", "Baby, lay on back and relax", "Kick your pretty feet up on my dash", "No need to go nowhere fast", "let's enjoy right here where we at", \
        ...
        "If it's meant to be, it'll be,",  "it'll be Baby, just let it be", "If it's meant to be, it'll", "be, it'll be. Baby, just let it be", "So won't you ride with me", "ride with me? See where this", "thing goes. If it's meant to be, ", \
        "it'll be, it'll be. Baby, ", "if it's meant to be. I don't mean ", "to be so uptight. But,", "my heart's been hurt a couple times", "by a couple guys that didn't treat me right", "I ain't gon' lie, ain't gon' lie", "Cause I'm tired of the fake love, show me what you're made of ", "Boy, make me believe", \
